...
Component({
    ...
    methods: {
        ...
        //删除操作
        keybordEventDele: function (e) {
            //删掉最后一个数字的运费价格
            let newFeeShipping = this.properties.argument.dealPayFeeShipping.slice(0, this.properties.argument.dealPayFeeShipping.length - 1);
            //给当前光标的内容更新
            this.setData({
                "Odata.dealPayFeeShipping": newFeeShipping
            })
        ...
        //点击确定之后
        keybordEventSumb: function () {
            this.properties.argument.submit();
        },
        //隐藏小键盘
        keybordEventHide: function (e) {
            let that = this;
            that.setData({
